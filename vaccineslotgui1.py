...
#app.iconbitmap("E:\pp\project jarves\school project\files\covid-vaccine.ico")
...
# Buttons
search_vaccine_image = PhotoImage(file= "E:\\pp\\project jarves\\python\\dpsg covid project\\school project\\files\\search-icon.png")
